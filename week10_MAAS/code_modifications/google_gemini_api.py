...
class GeminiLLM(BaseLLM):
    ...
    def __init__(self, config: LLMConfig):
        ...
        self.config = config
        configured_model = config.model or "gemini-1.5-pro"
    ...
    def _extract_chunk_text(self, chunk: GenerateContentResponse) -> str:
        # logger.info(f"DEBUG: Processing chunk: {chunk}")
        fragments: list[str] = []
